...
RESOURCES += src/qt/Tattoo.qrc src/qt/Tattoo_locale.qrc

TRANSLATIONS += src/qt/locale/Tattoo_bg.ts \
                src/qt/locale/Tattoo_de.ts \
                src/qt/locale/Tattoo_en.ts \
                src/qt/locale/Tattoo_es.ts \
                src/qt/locale/Tattoo_fi.ts \
                src/qt/locale/Tattoo_fr.ts \
                src/qt/locale/Tattoo_it.ts \
                src/qt/locale/Tattoo_ja.ts \
                src/qt/locale/Tattoo_pl.ts \
                src/qt/locale/Tattoo_pt.ts \
                src/qt/locale/Tattoo_ru.ts \
                src/qt/locale/Tattoo_sk.ts \
                src/qt/locale/Tattoo_sv.ts \
                src/qt/locale/Tattoo_vi.ts \
                src/qt/locale/Tattoo_zh_CN.ts \
                src/qt/locale/Tattoo_zh_TW.ts
