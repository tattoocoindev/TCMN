Contributing to Tattoo Core
============================

The Tattoo Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tattoo Core project, and is not to be
confused with overall Tattoo Network Protocol consensus changes.

Whether a pull request is merged into Tattoo Core rests with the project merge
...
Patches that change Tattoo consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tattoo consensus, it must have been
...
The project leader is the release manager for each Tattoo Core release.
