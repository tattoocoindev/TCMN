...
*Setup instructions for a gitian build of Tattoo using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Tattoo
...
- [Building Tattoo](#building-Tattoo)
...
Clone the git repositories for Tattoo and gitian and then checkout the Tattoo version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/Tattoo-crypto/Tattoo.git
cd Tattoo
...
Follow the instructions in [doc/release-process.md](release-process.md) in the Tattoo repository
...
To build Tattoo (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the Tattoo repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/Tattoo/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/Tattoo-crypto/Tattoo
...
For example:
```bash
URL=https://github.com/crowning-/Tattoo.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit Tattoo=${COMMIT} --url Tattoo=${URL} ../Tattoo/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit Tattoo=${COMMIT} --url Tattoo=${URL} ../Tattoo/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit Tattoo=${COMMIT} --url Tattoo=${URL} ../Tattoo/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/Tattoo-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/Tattoo-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/Tattoo-build.assert
```
...
[Tattoo/gitian.sigs](https://github.com/Tattoo-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
