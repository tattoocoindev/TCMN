Tattoo Core version 2.2.1 is now available from:

  <https://github.com/Tattoo-project/Tattoo/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/Tattoo-project/Tattoo/issues>

Compatibility
==============

Tattoo Core is extensively tested on multiple operating systems using
...
Tattoo Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Tattoo was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/Tattoo-project-translations/).
