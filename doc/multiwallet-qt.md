...
In order to support loading of multiple wallets in Tattoo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Tattoo.cpp.
...
Changes to Tattoo.cpp
----------------------
Tattoo.cpp is the entry point into Tattoo-qt, and as such, will require some minor modifications to provide hooks for
