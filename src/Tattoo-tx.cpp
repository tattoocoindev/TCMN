...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Tattoo Core Tattoo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Tattoo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Tattoo transaction") + "\n" +
                               "  Tattoo-tx [options] -create [commands]   " + _("Create hex-encoded Tattoo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Tattoo transaction
