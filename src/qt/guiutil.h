...
/** Utility functions used by the Tattoo Qt UI.
 */
namespace GUIUtil
{
...
// Render Tattoo addresses in monospace font
...
// Parse "Tattoo:" URI into recipient object, return true on successful parsing
