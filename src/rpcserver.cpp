...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tattoo features */
        {"Tattoo", "masternode", &masternode, true, true, false},
        {"Tattoo", "masternodelist", &masternodelist, true, true, false},
        {"Tattoo", "mnbudget", &mnbudget, true, true, false},
        {"Tattoo", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"Tattoo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Tattoo", "mnsync", &mnsync, true, true, false},
        {"Tattoo", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"Tattoo", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Tattood, or the -server option to Tattoo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Tattoo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12502/\n";
}
