...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 12401;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Tattoo starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 210000;
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 3 * 60; // Tattoo: 1 minute
        nTargetSpacing = 3 * 60;  // Tattoo: 1 minute
        ...
        vSeeds.push_back(CDNSSeedData("tmn.point2this.com", "tmn.point2this.com"));
		vSeeds.push_back(CDNSSeedData("104.236.190.45", "104.236.190.45"));
        ...
        strObfuscationPoolDummyAddress = "TTHprUHgceGPTTaAmajjcELftpUTKNhyJt";
...
public:
    CTestNetParams()
    {
        ...
        nDefaultPort = 51474;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Tattoo: 1 day
        nTargetSpacing = 1 * 60;  // Tattoo: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("tomcawls.pw", "Tattoo-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("tukkerballs.pw", "Tattoo-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("suckfive.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("98.197.192.120", "88.198.192.110"));
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Tattoo addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet Tattoo script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet Tattoo BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Tattoo BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Tattoo BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Tattoo: 1 day
        nTargetSpacing = 1 * 60;        // Tattoo: 1 minutes
